...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-64">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-chart-3/20 rounded-full blur-3xl animate-pulse delay-2000" />
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          <div className="inline-flex items-center space-x-2 glass rounded-full px-6 py-3 text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-16 max-w-4xl mx-auto">
            <div className="glass rounded-2xl p-6 text-center glass-hover">
              ...
              <h3 className="text-lg font-semibold mb-2">UAE Communities</h3>
            ...
            <div className="glass rounded-2xl p-6 text-center glass-hover">
              <div className="w-12 h-12 bg-chart-2/20 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <div className="glass rounded-2xl p-6 text-center glass-hover">
              ...
              <p className="text-muted-foreground text-sm">Make a meaningful difference in your local UAE community</p>
            </div>
          </div>
        </div>
      </div>
